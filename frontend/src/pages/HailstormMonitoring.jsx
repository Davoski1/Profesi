...
export default function HailstormMonitoring() {
  ...
  const handleLocationSelect = async (location) => {
    ...
    try {
      const response = await ApiService.predictHailstorm(location.latitude, location.longitude)
    ...
    >
      ...
      <div className="monitoring-content">
        <motion.h1 className="page-title">
          ⛈️ Hailstorm Monitoring & Prediction
        </motion.h1>
          ...
          >
            ...
            <div className="current-status">
              ...
              <div className="status-grid">
                ...
                <div className="status-item">
                  <span className="label">Hail Size</span>
                  <span className="value">{predictions.hail_size?.toFixed(1)} mm</span>
                </div>
                <div className="status-item">
                  <span className="label">Storm Intensity</span>
                  <span className="value">{(predictions.storm_intensity * 100)?.toFixed(0)}%</span>
                </div>
                <div className="status-item">
                  <span className="label">Wind Speed</span>
                  <span className="value">{predictions.wind_gust_speed?.toFixed(1)} km/h</span>
                </div>
              </div>
            </div>
